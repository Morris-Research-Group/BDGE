...
In [explore_clean_yeast.ipynb](explore_clean_yeast.ipynb) we identified the example genes we discuss in Figures 1, 2 and 3. 
...
### Figure 5
Can be reproduced via [explore_clean_yeast_consistency.ipynb](explore_clean_yeast_consistency.ipynb).
